const ApiKey = "47f383a57ddf42438054467c063ea8bb";
...
function showTeamInfo(id){
    ...
    fetch(url, fetchHeader)
        ...
        .then(resJson=> {
            ...
            <h4 class="header">Nama Tim Bola</h4>
            <div class="card horizontal">
              ...
              <div class="card-stacked">
                <div class="card-content">
                  <p>Nama : ${resJson.name}</p>
                  <p>Nama Pendek : ${resJson.shortName}</p>
                  <p>No.Telepon : ${resJson.phone}</p>
                  <p>Warna Club : ${resJson.clubColors}</p>
                  <p>Lokasi : ${resJson.venue}</p>
                </div>
                <div class="card-action">
                  <a href="#">Link : ${resJson.website}</a>
                </div>
              </div>
            </div>
          </div>` ;
